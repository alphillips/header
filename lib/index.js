  ...
  function Header(props) {
      ...
      try {
        ...
        if (links) {
          links.map(function (link, i) {
            return curlink ? curlink === link ? curlink.className = curlink.className + ' current' : link.className.remove('current') : link.className.remove('current');
          });
        }
      } catch (e) {}
    ...
    _this.showMenuContext = function () {
      try {
        ...
        if (links) {
          links.map(function (link, i) {
            return curlink ? curlink === link ? curlink.className = 'current' : link.className = '' : link.className = '';
          });
        }
      } catch (e) {}
    };
